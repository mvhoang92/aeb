...
| 66-case scenario composition: 24 CCRm, 30 CCRb, 12 cut-in | `configs/scenarios/suites/system_limit_extended_sweep.yaml` | `docs/log/FINAL_EVIDENCE_PACK_20260628.md` | `paper_v2` treats clear-road/adjacent/curve/cut-out/multi-actor cases as additional checks, not part of the 63/66 aggregate. |
...
- The Vietnamese review copy retains its T5/Times typography and is built with
  pdfLaTeX; it is not subject to the six-page English-paper target. In
  `paper_v2`, title, abstract, contribution framing, and the interpretation of
  the 66-case aggregate were updated to match the English master.
